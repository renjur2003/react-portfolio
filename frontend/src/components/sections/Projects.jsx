      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Tilt>
              <div className="p-6 rounded-xl glass hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all h-full">
            ...
            <Tilt>
              <div className="p-6 rounded-xl glass hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] transition-all h-full">
                <h3 className="text-xl font-bold mb-2">
                  Alleppey Boat Hub – MERN Stack Project
                </h3>
                <p className="text-gray-400 mb-4">
                  A full-stack tourism website built using the MERN stack for a real
                  business in Alleppey, Kerala. Features boat booking enquiry system,
                  admin dashboard, and email notifications.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  {["React.js", "Node.js", "Express.js", "MongoDB", "Resend"].map(
                    (tech, key) => (
                      <span
                        key={key}
                        className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                ...
                <div className="flex justify-between items-center">
                  <a
                    href="https://alleppeyboathub.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-500 hover:text-blue-300 transition-colors my-4"
                  >
